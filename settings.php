...
// display their username to show who they are.
...
<body>
  ...
  <div class='container'>
    ...
    <div class='starter-template'>
      ...
      <form action="passChange.php" method="POST" class="">
        <div class="row">
      ...
      <p class='lead'>Use this document as a way to quickly start any new project.<br> All you get is this text and a mostly barebones HTML document.</p>
      <form action="deleteUser.php" method="POST" class="form-signin">
        <label class="checkbox">
            <input type="checkbox" name="areyousure" value="iamsure"> Are you sure?
          </label>
